...
QT_MOC_LITERAL(1, 13, 15), // "ReadFrameSignal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5) // "frame"

    },
    "CameraThread\0ReadFrameSignal\0\0frame"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ReadFrameSignal((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::ReadFrameSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::ReadFrameSignal(QImage _t1)
{
